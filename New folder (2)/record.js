...
form.addEventListener('submit', function(e)
{
    ...
    Allelement.map((ele)=>
    {
        ...
        let inp1 = document.createElement('th');
        let inp2 = document.createElement('th');
        let inp3 = document.createElement('th');
        let inp4 = document.createElement('th');
        let inp5 = document.createElement('th');
        let inp6 = document.createElement('th');
        let inp7 = document.createElement('th');
